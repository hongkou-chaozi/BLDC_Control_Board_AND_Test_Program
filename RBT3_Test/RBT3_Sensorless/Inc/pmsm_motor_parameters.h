...
#define RS                     7.20 /* Stator resistance , ohm*/
#define LS                     0.005360 /* Stator inductance, H
...
#define NOMINAL_CURRENT         2384
#define MOTOR_MAX_SPEED_RPM     2500 /*!< Maximum rated speed  */
#define MOTOR_VOLTAGE_CONSTANT  12.6 /*!< Volts RMS ph-ph /kRPM */
#define ID_DEMAG                -2384 /*!< Demagnetization current */
